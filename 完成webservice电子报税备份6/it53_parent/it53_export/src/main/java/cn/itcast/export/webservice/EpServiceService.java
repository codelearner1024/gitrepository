 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.export.itcast.cn/", wsdlLocation = "http://localhost/jk_export/ws/export?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost/jk_export/ws/export?wsdl");
